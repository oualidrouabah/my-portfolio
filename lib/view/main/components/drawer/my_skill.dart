  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'JavaScript',image: 'assets/icons/js.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Firebase',image: 'assets/icons/firebase.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'MongoDB',image: 'assets/icons/mongo.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.2, title: 'Bloc',image: 'assets/icons/bloc.png'),
      ],);
  }
}
